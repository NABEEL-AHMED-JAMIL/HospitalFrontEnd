        ...
        this.route.params.subscribe(params => {
            ...
            this.patientService.getAllPatientNote(this.mrNo).subscribe(patientNoteList => {
                ...
                if(this.patientNoteList.length == 0){
                    ...
                    this._sharedService.patientEmitChange("Mr# ("+this.patientNoteList[0].patientMrNo+") Patient Name("+this.patientNoteList[0].patientName+")");
    ...
    public onCellClick(data: any): any {
        ...
        subscribe((isConfirmed :any)=> {
            if (isConfirmed == "edit") {
                ...
                this.noteService.deleteNote(data.row.noteId).subscribe(deletedata => {
